...
document.addEventListener('DOMContentLoaded', () => {
    ...
    withdrawForm.addEventListener('submit', (e) => {
        ...
        if (confirm(`Confirm withdrawal of ₱${amount} using ${method}? AI will verify and optimize this transaction.`)) {
            ...
            setTimeout(() => {
                ...
                withdrawForm.reset();
                updateAiSuggestion();
            }, 2000); // Simulate AI processing with smooth timing
        }
    });
    ...
    function startVoiceInput() {
        ...
        recognition.onstart = () => {
            ...
            voiceBtn.style.boxShadow = '0 0 15px rgba(255, 107, 107, 0.7)';
            voiceBtn.style.animation = 'pulse 1.5s infinite ease-in-out';
        };
        ...
        recognition.onerror = (error) => {
            alert('Voice recognition failed. Please try typing the amount.');
            withdrawAmount.placeholder = 'Enter amount (min ₱100)';
            withdrawAmount.disabled = false;
            const voiceBtn = document.querySelector('.voice-btn');
            voiceBtn.style.color = '#e0f7ff';
    ...
    const particles = [];
    const particleCount = 120; // Maintained for rich 3D effect
    ...
    window.showAnalytics = function() {
        ...
        // Sample data for Chart.js with enhanced visualization
        const chart = new Chart(ctxChart, {
            ...
            options: {
                ...
                animation: { duration: 1000, easing: 'easeOutQuart' }, // Smooth chart animations
                scales: {
                    y: {
                        beginAtZero: false,
                        title: { display: true, text: 'Balance (₱)', color: 'white', font: { size: 14, weight: 'bold' } },
                        ticks: { color: 'white', font: { size: 12 } },
                        grid: { color: 'rgba(255, 255, 255, 0.1)' }
                    },
                    x: {
                        title: { display: true, text: 'Month', color: 'white', font: { size: 14, weight: 'bold' } },
                        ticks: { color: 'white', font: { size: 12 } },
                        grid: { color: 'rgba(255, 255, 255, 0.1)' }
                    }
                },
                plugins: {
                    ...
                    tooltip: { 
                        ...
                        borderWidth: 1,
                        caretSize: 5,
                        animation: { duration: 300, easing: 'easeOutQuart' } // Smooth tooltip animations
                    }
                },
                interaction: {
                    mode: 'nearest',
    ...
    window.closeAnalyticsModal = function() {
        ...
        // Destroy chart to prevent memory leaks and ensure smooth transitions
        Chart.getChart('analyticsChart')?.destroy();
    };
    ...
    function showSuccessMessage(amount, method) {
        ...
        success.style.animation = 'fadeIn 0.5s ease-in-out, pulse 2s infinite ease-in-out';
        ...
        modalContent.innerHTML = `
            <div class="history-list">
                <div class="history-item">
                    ...
                    <p>Status: Completed <span class="ai-indicator">✅</span></p>
                </div>
                <div class="history-item">
